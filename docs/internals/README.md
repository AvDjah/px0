...
- [Vim Navigation Mode](vim-navigation.md): Toggleable read-only Vim input layer (Normal/Visual/Cmdline), data-driven keymap (`web/src/vim-keymap.js`, contract in `docs/vim.md`), and Ex command dispatch over existing primitives.
